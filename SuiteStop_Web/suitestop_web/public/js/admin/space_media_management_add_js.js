/** space_media_management module script */
Project.modules.space_media_management = {
    init: function() {
    ...
    validate: function (){
        ...
        $("#frmaddupdate").validate({
		    ...
		    "images": {
		        "required": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.SPACE_MEDIA_MANAGEMENT_IMAGES)
		    },
            "video": {
		        "required": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.SPACE_MEDIA_MANAGEMENT_VIDEO)
		    },
            "space_name": {
		        "required": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.SPACE_MEDIA_MANAGEMENT_NAME)
		    },
            "first_name": {
		        "required": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.SPACE_MEDIA_MANAGEMENT_USER_NAME)
		    },
		},
...
Project.modules.space_media_management.init();
