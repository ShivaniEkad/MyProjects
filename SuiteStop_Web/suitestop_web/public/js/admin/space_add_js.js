/** space_management module script */
$('#space_name').keypress(function (e) {
...
Project.modules.space_management = {
    init: function() {
    ...
    validate: function (){
        ...
        $("#frmaddupdate").validate({
            ...
            messages : {
            "user_id": {
                "required": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.SPACE_MANAGEMENT_USER_NAME)
            },
            "space_name": {
                "required": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.SPACE_MANAGEMENT_NAME)
            },
            "address": {
                "required": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.SPACE_MANAGEMENT_ADDRESS)
            },
            "city": {
                "required": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.SPACE_MANAGEMENT_CITY)
            },
            "state": {
                "required": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.SPACE_MANAGEMENT_STATE)
            },
            "zipcode": {
                "required": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.SPACE_MANAGEMENT_ZIPCODE)
            },
            "stylist_required": {
                "required": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.SPACE_MANAGEMENT_STYLIST_REQUIRED)
            },
            "space_details": {
                "required": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.SPACE_MANAGEMENT_SPACE_DETAILS)
            },
            "status": {
                "required": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.SPACE_MANAGEMENT_STATUS)
            }
        },
    ...
    initEvents: function(elem){
                ...
                $('#upload_drop_zone_space_logo').width($('#uploadify_space_logo').width() + 18);
                $('#uploadify_space_logo').fileupload({
...
acceptFileTypes : 'gif|png|jpg|jpeg|jpe|bmp|ico',
                    dropZone: $('#upload_drop_zone_space_logo, #upload_drop_zone_space_logo + .upload-src-zone'),
                    formData: {
                        'unique_name' : 'space_logo', 
                        'id' : $('#id').val(),
                        'type' : 'uploadify'
                    },
                    add: function(e, data) {
...
Project.modules.space_management.init();
