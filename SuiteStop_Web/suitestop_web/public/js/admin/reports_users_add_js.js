/** reports_users module script */
Project.modules.reports_users = {
    init: function() {
    ...
    validate: function (){
        ...
        $("#frmaddupdate").validate({
            ...
            messages : {
            "reported_by": {
                "required": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.REPORTS_USERS_REPORTED_BY)
            },
            "reported_on": {
                "required": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.REPORTS_USERS_REPORTED_ON)
            },
            "message": {
                "required": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.REPORTS_USERS_MESSAGE)
            }
        },
...
Project.modules.reports_users.init();
