/** post_management module script */
Project.modules.post_management = {
    init: function() {
    ...
    validate: function (){
        ...
        $("#frmaddupdate").validate({
            ...
            messages : {
            "user_id": {
                "required": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.POST_MANAGEMENT_USER_NAME)
            },
            "title": {
                "required": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.POST_MANAGEMENT_TITLE)
            },
            "post_details": {
                "required": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.POST_MANAGEMENT_DETAILS)
            }
        },
...
Project.modules.post_management.init();
