...
class Reset_password_phone extends Cit_Controller
{
    ...
    public function check_mobile_number($input_params = array())
    {
        ...
        try {
            ...
            $usertype = isset($input_params["usertype"]) ? $input_params["usertype"] : "";
            $this->block_result = $this->users_model->check_mobile_number($mobile_number, $reset_key, $usertype);
    ...
    public function update_user_password($input_params = array())
    {
        ...
        try {
            ...
            if (isset($input_params["usertype"])) {
                $params_arr["usertype"] = $input_params["usertype"];
            }
