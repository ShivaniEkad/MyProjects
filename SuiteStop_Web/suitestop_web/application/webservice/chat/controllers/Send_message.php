...
class Send_message extends Cit_Controller
{
    ...
    public function add_message($input_params = array())
    {
        ...
        try {
            ...
            if (isset($input_params["space_id"])) {
                $params_arr["space_id"] = $input_params["space_id"];
            }
            if (isset($input_params["message"])) {
                $params_arr["message"] = $input_params["message"];
            }
    ...
    public function get_user_details_for_send_notifi($input_params = array())
    {
        ...
        try {
            ...
            $this->block_result = $this->messages_model->get_user_details_for_send_notifi($user_id, $receiver_id, $space_id);
    ...
    */
    public function post_notification($input_params = array())
    {
        ...
        try {
            ...
            $this->block_result = $this->notification_model->chat_message_post_notification($params_arr);
        } catch (Exception $e) {
            $success = FAILED_CODE;
            $this->block_result["data"] = array();
        }
    ...
    public function push_notification($input_params = array())
    {
        ...
        try {
            ...
            $send_vars = array(
                ...
                array(
                    "key" => "entity_id",
                    "value" => $input_params["m_message_id"],
                    "send" => "Yes",
                ),
                array(
                    "key" => "space_name",
                    "value" => $input_params["space_name"],
                    "send" => "Yes",
                ),
                array(
                    "key" => "space_id",
