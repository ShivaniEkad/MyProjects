...
class Blocked_user_list extends Cit_Controller
{
    ...
    public function get_all_blocked_user_list($input_params = array())
    {
        ...
        try {
            ...
            $this->block_result = $this->user_block_model->get_all_blocked_user_list($input_params,$page_index, $this->settings_params);
        ...
        $input_params["get_all_blocked_user_list"]['success'] = $this->block_result['success'];
        $input_params = $this->wsresponse->assignSingleRecord($input_params, $input_params["get_all_blocked_user_list"]);
        //$input_params["get_all_blocked_user_list"] = $this->block_result["data"];
