...
/**
 * Description of Reject request Extended Controller
 *
 * @module Extended Reject request
 *
 * @class Cit_Reject_request.php
 *
 * @path application\webservice\space\controllers\Cit_Reject_request.php
 *
 * @author Suresh Nakate
 *
 * @date 06.09.2021
 */
class Cit_Reject_request extends Reject_request
{
    /**
    ...
    public function PrepareHelperMessage($input_params=array())
    {
        ...
        $this->db->where('nt.vTemplateCode', 'Reject_request');
