 ...
 *
 * @class Accept_request.php
 *
 * @path application\webservice\request\controllers\Accept_request.php
 *
 * @version 4.4
 *
 ...
 * @since 06.09.2021
 */
class Accept_request extends Cit_Controller
{
     ...
     */
    public function rules_accept_request($request_arr = array())
    {
        $valid_arr = array(
            "entity_id" =>array(
                array(
        ...
        $valid_res = $this->wsresponse->validateInputParams($valid_arr, $request_arr, "accept_request");
     ...
     */
    public function start_accept_request($request_arr = array(), $inner_api = FALSE)
    { 
        try
        {
            $validation_res = $this->rules_accept_request($request_arr);
            ...
            if($condition_res['success']){
                ...
                if ($condition_res["success"]) {
                    ...
                    //$output_response = $this->accept_request_finish_success($input_params);
                ...
                $output_response = $this->accept_request_finish_failure($input_params);
                return $output_response;
            }  
        }
        catch(Exception $e)
    ...
    public function request_status($input_params = array())
    {
        ...
        try
        {
            ...
            if ($input_params["notification_id"] == ""){
            ...
            $this->block_result = $this->request_model->accept_request_for_notification($where_arr,$params_arr);
            } else{
                $params_arr["notification_id"] = $input_params["notification_id"];
                ...
                $this->block_result = $this->request_model->accept_request($where_arr,$params_arr);
    ...
    /**
     * Method is used to process query block.affected_rows
     * 
     * @param array $input_params input_params array to process loop flow.
     * 
     * @return array $input_params returns modfied input_params array.
    ...
    */
    public function post_notification($input_params = array())
    {
        ...
        try {
            ...
            if (isset($input_params["entity_id"])) {
                $params_arr["entity_type"] = "Request Accepted";
                $params_arr["entity_id"] = $input_params["entity_id"];
            }
            $params_arr["redirection_type"] = "Request Accepted";
            $params_arr["_enotificationtype"] = "Request Accepted";
            $input_params["notification_type"] = "Request Accepted";
    ...
    public function messages_finish_success($input_params = array())
    {
        ...
        $func_array["function"]["name"] = "accept_request";
    ...
    /**
     * accept_request_finish_success method is used to process finish flow.
     * @created  | 29.01.2016
     * @modified ---
     * @param array $input_params input_params array to process loop flow.
     * @return array $responce_arr returns responce array of api.
     */
    public function accept_request_finish_success($input_params = array())
    {
        $setting_fields = array(
            "success" => SUCCESS_CODE,
            "message" => "accept_request_finish_success",
        );
         $output_fields = array(
            'affected_rows',
        );
     ...
     * @return array $responce_arr returns responce array of api.
     */
    public function accept_request_finish_failure($input_params = array())
    {
        $setting_fields = array(
            "success" => FAILED_CODE,
            "message" => "accept_request_finish_failure",
        );
        $output_fields = array();
