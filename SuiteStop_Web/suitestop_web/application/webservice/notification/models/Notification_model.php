...
class Notification_model extends CI_Model
{
    ...
    /**
     * Used to execute database queries for request user API.
     * 
     * @param array $params_arr params_arr array to process query block.
     * @return array $return_arr returns response of query block.
     */
    public function request_post_notification($params_arr = array())
    {
        try {
            $result_arr = array();
            ...
            $this->db->select("s.iUser_id AS r_user_id");
            $this->db->where("s.iSpace_id", $params_arr["receiver_id"]);
            $result_obj=$this->db->get();
            $receiver_arr = is_object($result_obj) ? $result_obj->result_array() : array();
            if (isset($params_arr["receiver_id"])) {
                $this->db->set("receiver_id", $receiver_arr[0]['r_user_id']);
            }
            if (isset($params_arr["entity_type"])) {
                $this->db->set("entity_type", $params_arr["entity_type"]);
            }
            if (isset($params_arr["receiver_id"])) {
                $this->db->set("space_id", $params_arr["receiver_id"]);
            }
    ...
    public function get_all_notification($params_arr = array(), &$settings_params)
    {
        try {
            ...
            $this->db->where("n.iSysRecDeleted=", "0");
            ...
            $this->db->select("n.space_id as space_id");
            $this->db->join("space as s","s.iSpace_id = n.space_id","LEFT");
    ...
    /**
     * Used to execute database queries for notifications API.
     * 
     * @param array $params_arr params_arr array to process query block.
     * @return array $return_arr returns response of query block.
     */
    public function add_post_notification($params_arr = array())
    { 
        try {
            $result_arr = array();
            ...
            if (isset($params_arr["s_users_id"])) {
                $this->db->set("sender_id", $params_arr["s_users_id"]);
            }
            if (isset($params_arr["r_users_id"])) {
                $this->db->set("receiver_id", $params_arr["r_users_id"]);
            }
            if (isset($params_arr["entity_type"])) {
                $this->db->set("entity_type", $params_arr["entity_type"]);
            }
            ...
            if (isset($params_arr["entity_id"])) {
                $this->db->set("space_id", $params_arr["entity_id"]);
            }
            if (isset($params_arr["notification_message"])) {
                $this->db->set("notification_message", $params_arr["notification_message"]);
            }
            ...
            $result_param = "insert_id";
            $result_arr[0][$result_param] = $insert_id;
            $result_arr[0]["r_device_token"] = $params_arr['r_device_token'];
            $result_arr[0]["r_users_id"] = $params_arr['r_users_id'];
            $success = 1;
        } catch(Exception $e) {
            $params_arr['db_query'] = $this->db->last_query();
            $this->general->apiLogger($params_arr, $e);
    ...
    /**
     * Used to execute database queries for request status notification API.
     * 
     * @param array $params_arr params_arr array to process query block.
     * @return array $return_arr returns response of query block.
     */
    public function request_status_post_notification($params_arr = array())
    { 
        try {
            $result_arr = array();
            ...
            $this->db->where("ur.iUser_request_id", $params_arr["entity_id"]);
            $result_obj=$this->db->get();
            $receiver_arr = is_object($result_obj) ? $result_obj->result_array() : array();
            $this->db->set("space_id", $receiver_arr[0]['space_id']);
    ...
    /**
     * Used to execute database queries for send chat message notifications API.
     * 
     * @param array $params_arr params_arr array to process query block.
     * @return array $return_arr returns response of query block.
     */
    public function chat_message_post_notification($params_arr = array())
    { 
        try {
            $result_arr = array();
            ...
            if (isset($params_arr["space_id"])) {
                $this->db->set("space_id", $params_arr["space_id"]);
            }
            if (isset($params_arr["entity_type"])) {
                $this->db->set("entity_type", $params_arr["entity_type"]);
            }
