...
class Users_management_model extends CI_Model 
{
    ...
    public function __construct() 
    {
        ...
        $this->grid_fields = array("u_profile_image", "u_first_name", "u_mobile_no", "u_added_at", "u_status", "u_usertype","u_updated_at");
    ...
    public function getData($extra_cond = "", $fields = "", $order_by = "", $group_by = "", $limit = "", $join = "No", $having_cond = '', $list = FALSE)
    {
            ...
            $this->db->select("u.eUserType AS u_usertype"); 
    ...
    public function getListConfiguration($name = "")
    {
        $list_config = array(
            ...
            "u_usertype" => array(
                ...
                "source_field" => "u_usertype",
                "display_query" => "u.eUserType",
                "entry_type" => "Table",
                "data_type" => "enum",
                "show_in" => "Both",
                "type" => "dropdown",
                "align" => "center",
                "label" => "User Type",
                "lang_code" => "USERS_MANAGEMENT_USER_TYPE",
                "label_lang" => $this->lang->line('USERS_MANAGEMENT_USER_TYPE'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
