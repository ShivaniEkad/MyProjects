...
<div class="module-list-container">
    <%include file="space_media_management_index_strip.tpl"%>
...
<%javascript%>
    ...
    {
        "name": "video",
        "label": "<%$list_config['video']['label_lang']%>"
    },
    {
        "name": "created_at",
    ...
    js_col_model_json = [
    {
        ...
        "editrules": {
            ...
            "infoArr": {
                "required": {
                    "message": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.SPACE_MEDIA_MANAGEMENT_USER_NAME)
                }
            }
        },
        "searchoptions": {
            "attr": {
                ...
                "aria-module-name": "space_media_management",
    ...
    }, 
      {
        ...
        "editrules": {
            ...
            "infoArr": {
                "required": {
                    "message": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.SPACE_MEDIA_MANAGEMENT_NAME)
                }
            }
        },
        "searchoptions": {
    ...
    },   
    {
        ...
        "editrules": {
            ...
            "infoArr": {
                "required": {
                    "message": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.SPACE_MEDIA_MANAGEMENT_IMAGES)
                }
            }
        },
        "searchoptions": {
    ...
    },   
    {
        ...
        "labelClass": "header-align-left",
        "resizable": true,
        "width": "<%$list_config['video']['width']%>",
        "search": <%if $list_config['video']['search'] eq 'No' %>false<%else%>true<%/if%>,
        "export": <%if $list_config['video']['export'] eq 'No' %>false<%else%>true<%/if%>,
        "sortable": <%if $list_config['video']['sortable'] eq 'No' %>false<%else%>true<%/if%>,
        "hidden": <%if $list_config['video']['hidden'] eq 'Yes' %>true<%else%>false<%/if%>,
        "hideme": <%if $list_config['video']['hideme'] eq 'Yes' %>true<%else%>false<%/if%>,
        "addable": <%if $list_config['video']['addable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "editable": <%if $list_config['video']['editable'] eq 'Yes' %>true<%else%>false<%/if%>,
        "align": "left",
        "edittype": "text",
        "editrules": {
            "required": true,
            "infoArr": {
                "required": {
                    "message": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.SPACE_MEDIA_MANAGEMENT_VIDEO)
                }
            }
        },
        "searchoptions": {
            "attr": {
                "aria-grid-id": el_tpl_settings.main_grid_id,
                "aria-module-name": "space_media_management",
                "aria-unique-name": "video",
                "autocomplete": "off"
            },
            "sopt": strSearchOpts,
            "searchhidden": <%if $list_config['video']['search'] eq 'Yes' %>true<%else%>false<%/if%>
        },
        "editoptions": {
            "aria-grid-id": el_tpl_settings.main_grid_id,
            "aria-module-name": "space_media_management",
        ...
        "ctrl_type": "textbox",
        "default_value": "<%$list_config['video']['default']%>",
        "filterSopt": "bw",
        "formatter": formatAdminModuleEditLink,
        "unformat": unformatAdminModuleEditLink
    },   
