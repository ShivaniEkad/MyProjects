...
<div class="module-form-container">
    <%include file="post_management_add_strip.tpl"%>
    <div class="<%$module_name%>" data-form-name="<%$module_name%>">
        <div id="ajax_content_div" class="ajax-content-div top-frm-spacing" >
            ...
            <div id="scrollable_content" class="scrollable-content popup-content top-block-spacing ">
                <div id="post_management" class="frm-module-block frm-elem-block frm-stand-view">
                    <!-- Module Form Block -->
                        ...
                        <div class="main-content-block " id="main_content_block">
                            <div style="width:98%" class="frm-block-layout pad-calc-container">
                                    ...
                                    <div class="content <%$rl_theme_arr['frm_stand_label_align']%>">
                                            ...
                                            <div class="form-row row-fluid " id="cc_sh_user_id">
                                                ...
                                                <div class="form-right-div  <%if $mode eq 'Update'%>frm-elements-div<%/if%> ">
                                                        ...
                                                        <input type="text" placeholder="" value="<%$data['user_id']|@htmlentities%>" name="user_id" id="user_id" title="<%$this->lang->line('POST_MANAGEMENT_USER_NAME')%>"  data-ctrl-type='textbox'  class='frm-size-medium'  />
                                                </div>
                                            ...
                                            <div class="form-row row-fluid " id="cc_sh_title">
                                                <label class="form-label span3 ">
                                                    <%$form_config['title']['label_lang']%> <em>*</em> 
                                                </label> 
                                                <div class="form-right-div  <%if $mode eq 'Update'%>frm-elements-div<%/if%> ">
                                                
                                                        <input type="text" placeholder="" value="<%$data['title']|@htmlentities%>" name="title" id="title" title="<%$this->lang->line('POST_MANAGEMENT_TITLE')%>"  data-ctrl-type='textbox'  class='frm-size-medium'  />
                                                </div>
                                                <div class="error-msg-form "><label class='error' id='titleErr'></label></div>
                                            </div> 
                                            <div class="form-row row-fluid " id="cc_sh_post_details">
                                                <label class="form-label span3 ">
                                                    <%$form_config['post_details']['label_lang']%> <em>*</em> 
                                                </label> 
                                                <div class="form-right-div  <%if $mode eq 'Update'%>frm-elements-div<%/if%> ">
                                                
                                                        <input type="text" placeholder="" value="<%$data['post_details']|@htmlentities%>" name="post_details" id="post_details" title="<%$this->lang->line('POST_MANAGEMENT_DETAILS')%>"  data-ctrl-type='textbox'  class='frm-size-medium'  />
                                                </div>
                                                <div class="error-msg-form "><label class='error' id='post_detailsErr'></label></div>
                                            </div>                                 
                                ...
                                <div class="frm-bot-btn <%$rl_theme_arr['frm_stand_action_bar']%> <%$rl_theme_arr['frm_stand_action_btn']%> popup-footer">
                                    ...
                                    <%/if%>
                                    <%include file="post_management_add_buttons.tpl"%>
                                </div>
                            </div>
                            <div class="clear"></div>
                        </form>
...
<%javascript%>
    ...
    callSwitchToSelf();
<%/javascript%>
<%$this->js->add_js('admin/post_add_js.js')%>
<%if $this->input->is_ajax_request()%>
    <%$this->js->js_src()%>
<%/if%> 
<%if $this->input->is_ajax_request()%>
...
<%/if%> 
<%javascript%>
    Project.modules.post_management.callEvents();
<%/javascript%>