    ...
    <div class="heading" id="top_heading_fix">
        ...
        <h3>
            <div class="screen-title">
                ...
                <%$this->lang->line($mod_label_text)%> :: <%$this->lang->line('POST_IMAGES_MANAGEMENT_POST_IMAGES_MANAGEMENT')%>
        ...
        <div class="header-right-btns">
            ...
            <%if $backlink_allow eq true%>
                <div class="frm-back-to">
                    <a hijacked="yes" href="<%$admin_url%>#<%$mod_enc_url['index']%><%$extra_hstr%>"class="backlisting-link" title="<%$this->general->parseLabelMessage('GENERIC_BACK_TO_MODULE_LISTING','#MODULE_HEADING#','POST_IMAGES_MANAGEMENT_POST_IMAGES_MANAGEMENT')%>">
