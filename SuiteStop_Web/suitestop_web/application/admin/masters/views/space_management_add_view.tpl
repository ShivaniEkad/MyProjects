    ...
    <div class="<%$module_name%>" data-form-name="<%$module_name%>">
        <div id="ajax_content_div" class="ajax-content-div top-frm-spacing" >
            ...
            <div id="scrollable_content" class="scrollable-content popup-content top-block-spacing ">
                <!-- Module View Block -->
                <div id="space_management" class="frm-module-block frm-view-block frm-stand-view">
                                ...
                                <div class="content <%$rl_theme_arr['frm_stand_label_align']%>">
                                    ...
                                    <div class="form-row row-fluid " id="cc_sh_space_name">
                                     ...
                                     <div class="form-row row-fluid " id="cc_sh_address">
                                        <label class="form-label span3">
                                            <%$form_config['address']['label_lang']%>
                                        </label> 
                                        <div class="form-right-div frm-elements-div  <%if $mode eq 'Update'%>frm-elements-div<%/if%>">
                                            <%$img_html['address']%>
                                        </div>
                                     ...
                                     <div class="form-row row-fluid " id="cc_sh_zipcode">
                                        <label class="form-label span3">
                                            <%$form_config['zipcode']['label_lang']%>
                                        </label> 
                                        <div class="form-right-div frm-elements-div  <%if $mode eq 'Update'%>frm-elements-div<%/if%>">
                                            <%$img_html['zipcode']%>
                                        </div>
                                     ...
                                     <div class="form-row row-fluid " id="cc_sh_stylist_required">
                                        <label class="form-label span3">
                                            <%$form_config['stylist_required']['label_lang']%>
                                        </label> 
                                        <div class="form-right-div frm-elements-div  <%if $mode eq 'Update'%>frm-elements-div<%/if%>">
                                            <%$img_html['stylist_required']%>
                                        </div>
                                    </div>
                                     <div class="form-row row-fluid " id="cc_sh_space_details">
                                        <label class="form-label span3">
                                            <%$form_config['space_details']['label_lang']%>
                                        </label> 
                                        <div class="form-right-div frm-elements-div  <%if $mode eq 'Update'%>frm-elements-div<%/if%>">
                                            <%$img_html['space_details']%>
                                        </div>
                                    </div>
                                    <div class="form-row row-fluid " id="cc_sh_status">
                                        ...
                                        <div class="form-right-div frm-elements-div ">
                                            <span class="frm-data-label"><strong><%$this->general->displayKeyValueData($data['status'], $opt_arr['status'])%></strong></span>
                                        </div>
                                    </div>
