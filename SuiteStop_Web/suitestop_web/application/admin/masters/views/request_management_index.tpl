...
<div class="module-list-container">
    <%include file="request_management_index_strip.tpl"%>
...
<%javascript%>
    ...
    js_col_model_json = [
    {
        ...
        "editrules": {
            ...
            "infoArr": {
                "required": {
                    "message": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.REQUEST_MANAGEMENT_USER_NAME)
                }
            }
        },
        "searchoptions": {
            "attr": {
                ...
                "aria-module-name": "request_management",
    ...
    }, 
    {
        ...
        "editrules": {
            ...
            "infoArr": {
                "required": {
                    "message": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.REQUEST_MANAGEMENT_NAME)
                }
            }
        },
        "searchoptions": {
    ...
    },  
    {
        ...
        "editrules": {
            ...
            "infoArr": {
                "required": {
                    "message": ci_js_validation_message(js_lang_label.GENERIC_PLEASE_ENTER_A_VALUE_FOR_THE__C35FIELD_C35_FIELD_C46 ,"#FIELD#",js_lang_label.REQUEST_MANAGEMENT_STATUS)
                }
            }
        },
        "searchoptions": {
        ...
        "editoptions": {
            ...
            "data-placeholder": "<%$this->general->parseLabelMessage('GENERIC_PLEASE_SELECT__C35FIELD_C35' ,'#FIELD#', 'REQUEST_MANAGEMENT_STATUS')%>",
