...
/**
 * Description of Space media Management Model
 *
 * @category admin
 *
 * @package masters
 ...
 *
 * @class Space_media_management_model.php
 *
 * @path application\admin\masters\models\Space_media_management_model.php
 *
 * @version 4.4
 *
 * @author CIT Dev Team
...
class Space_media_management_model extends CI_Model
{
    public $table_name;
    public $table_alias;
    public $primary_key;
    ...
    public function __construct()
    {
        ...
        $this->table_name = "space_images";
        $this->table_alias = "si";
        $this->primary_key = "iSpace_images_id";
    ...
    public function getData($extra_cond = "", $fields = "", $order_by = "", $group_by = "", $limit = "", $join = "No", $having_cond = '', $list = FALSE)
    {
        ...
        else
        {
            ...
            $this->db->select("si.iSpace_id AS space_id");
            $this->db->select("si.vImages AS images");
            $this->db->select("si.vVideo AS video");
            $this->db->select("si.dtCreated_at AS created_at");
            //$this->db->select("('view') AS sys_custom_field_1", FALSE);
    ...
    {
        $list_config = array(
            "space_images_id" => array(
                "name" => "space_images_id",
                "table_name" => "space_images",
                "table_alias" => "si",
                "field_name" => "space_images_id",
                "source_field" => "space_images_id",
                "display_query" => "space_images_id",
                "entry_type" => "Table",
                "data_type" => "int",
                "show_in" => "Both",
                "type" => "dropdown",
                "align" => "center",
                "label" => "space images Id",
                "lang_code" => "space images Id",
                "label_lang" =>"space images Id",
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "first_name" => array(
                ...
                "align" => "left",
                "label" => "User name",
                "lang_code" => "SPACE_MEDIA_MANAGEMENT_USER_NAME",
                "label_lang" => $this->lang->line('SPACE_MEDIA_MANAGEMENT_USER_NAME'),
                "search" => "Yes",
                "width" => 50,
                "export" => "Yes",
                "sortable" => "Yes",
                ...
                "edit_link" => "Yes",
                "custom_link" => "Yes",
                "php_func" => "controller::listingValue3"
            ),
            "space_name" => array(
                "name" => "space_name",
                "table_name" => "space",
                ...
                "type" => "textbox",
                "label" => "space Name",
                "lang_code" => "SPACE_MEDIA_MANAGEMENT_NAME",
                "label_lang" => $this->lang->line('SPACE_MEDIA_MANAGEMENT_NAME'),
                "width" => 50,
            ...
            "images" => array(
                ...
                "type" => "textbox",
                "label" => "space images",
                "lang_code" => "SPACE_MEDIA_MANAGEMENT_IMAGES",
                "label_lang" => $this->lang->line('SPACE_MEDIA_MANAGEMENT_IMAGES'),
                "width" => 50,
            ...
            "video" => array(
                ...
                "type" => "textbox",
                "label" => "space video",
                "lang_code" => "SPACE_MEDIA_MANAGEMENT_VIDEO",
                "label_lang" => $this->lang->line('SPACE_MEDIA_MANAGEMENT_VIDEO'),
                "width" => 50,
            ...
            "created_at" => array(
                ...
                "align" => "left",
                "label" => "Created On",
                "lang_code" => "SPACE_MEDIA_MANAGEMENT_ADDED_AT",
                "label_lang" => $this->lang->line('SPACE_MEDIA_MANAGEMENT_ADDED_AT'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
    ...
    public function getFormConfiguration($name = "")
    {
        $form_config = array(
            ...
            "images" => array(
                ...
                "file_inline" => "Yes",
                "file_server" => "amazon",
                "file_folder" => $this->config->item("AWS_FOLDER_NAME")."/space_images",
                 "file_keep" => "space_images_id",
                "file_width" => "80",
                "file_height" => "80"
            ),
            "video" => array(
                ...
                "file_inline" => "Yes",
                "file_server" => "amazon",
                "file_folder" => $this->config->item("AWS_FOLDER_NAME")."/space_video",
                 "file_keep" => "space_images_id",
                "file_width" => "80",
                "file_height" => "80"
