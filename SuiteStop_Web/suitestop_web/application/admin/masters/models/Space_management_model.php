...
/**
 * Description of Space Management Model
 *
 * @category admin
 *
 * @package masters
 ...
 *
 * @class Space_management_model.php
 *
 * @path application\admin\masters\models\Space_management_model.php
 *
 * @version 4.4
 *
 * @author CIT Dev Team
...
class Space_management_model extends CI_Model
{
    ...
    public function getData($extra_cond = "", $fields = "", $order_by = "", $group_by = "", $limit = "", $join = "No", $having_cond = '', $list = FALSE)
    {
        ...
        elseif ($list == TRUE)
        {
            ...
            $this->db->select("s.eStatus AS status");
    ...
    public function getListConfiguration($name = "")
    {
        $list_config = array(
            ...
            "first_name" => array(
                ...
                "align" => "left",
                "label" => "User name",
                "lang_code" => "SPACE_MANAGEMENT_USER_NAME",
                "label_lang" => $this->lang->line('SPACE_MANAGEMENT_USER_NAME'),
                "search" => "Yes",
                "width" => 50,
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "space_name" => array(
                ...
                "source_field" => "space_name",
                "display_query" => "space_name",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_input" => "Both",
                "type" => "textbox",
                "label" => "space Name",
                "lang_code" => "SPACE_MANAGEMENT_NAME",
                "label_lang" => $this->lang->line('SPACE_MANAGEMENT_NAME'),
                "width" => 50,
            ),
            "address" => array(
                "name" => "address",
                ...
                "display_query" => "address",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_input" => "Both",
                "type" => "textbox",
                "label" => "space Address",
                "lang_code" => "SPACE_MANAGEMENT_ADDRESS",
                "label_lang" => $this->lang->line('SPACE_MANAGEMENT_ADDRESS'),
                "width" => 50,
            ),
            "city" => array(
                "name" => "city",
                ...
                "type" => "textbox",
                "label" => "space CITY",
                "lang_code" => "SPACE_MANAGEMENT_CITY",
                "label_lang" => $this->lang->line('SPACE_MANAGEMENT_CITY'),
                "width" => 50,
            ),
            "state" => array(
                "name" => "state",
                ...
                "type" => "textbox",
                "label" => "space state",
                "lang_code" => "SPACE_MANAGEMENT_STATE",
                "label_lang" => $this->lang->line('SPACE_MANAGEMENT_STATE'),
                "width" => 50,
            ),
            "zipcode" => array(
                "name" => "zipcode",
                ...
                "display_query" => "zipcode",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_input" => "Both",
                "type" => "textbox",
                "label" => "space ZIPCODE",
                "lang_code" => "SPACE_MANAGEMENT_ZIPCODE",
                "label_lang" => $this->lang->line('SPACE_MANAGEMENT_ZIPCODE'),
                "width" => 50,
            ),
            "stylist_required" => array(
                ...
                "table_name" => "space",
                "table_alias" => "s",
                "field_name" => "stylist_required",
                "source_field" => "stylist_required",
                "display_query" => "stylist_required",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_input" => "Both",
                "type" => "textbox",
                "label" => "stylist required",
                "lang_code" => "SPACE_MANAGEMENT_STYLIST_REQUIRED",
                "label_lang" => $this->lang->line('SPACE_MANAGEMENT_STYLIST_REQUIRED'),
                "width" => 50,
            ),
            "space_details" => array(
                "name" => "space_details",
                "table_name" => "space",
                "table_alias" => "s",
                "field_name" => "space_details",
                "source_field" => "space_details",
                "display_query" => "space_details",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_input" => "Both",
                "type" => "textbox",
                "label" => "space DETAILS",
                "lang_code" => "SPACE_MANAGEMENT_DETAILS",
                "label_lang" => $this->lang->line('SPACE_MANAGEMENT_DETAILS'),
                "width" => 50,
            ),
            "status" => array(
                "name" => "status",
                ...
                "field_name" => "eStatus",
                "source_field" => "status",
                "display_query" => "s.eStatus",
                "entry_type" => "Table",
                "data_type" => "enum",
                "show_input" => "Both",
                "type" => "dropdown",
                "label" => "Status",
                "lang_code" => "SPACE_MANAGEMENT_STATUS",
                "label_lang" => $this->lang->line('SPACE_MANAGEMENT_STATUS'),
                "width" => 50,
            ),
            "created_at" => array(
                "name" => "created_at",
                ...
                "align" => "left",
                "label" => "Created On",
                "lang_code" => "SPACE_MANAGEMENT_ADDED_AT",
                "label_lang" => $this->lang->line('SPACE_MANAGEMENT_ADDED_AT'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            /*"sys_custom_field_1" => array(
                ...
                "align" => "center",
                "label" => "Edit",
                "lang_code" => "SPACE_MANAGEMENT_EDIT",
                "label_lang" => "Edit",
                "width" => 50,
                "search" => "No",
                "export" => "No",
