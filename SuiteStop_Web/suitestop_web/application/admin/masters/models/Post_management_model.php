...
/**
 * Description of Post Management Model
 *
 * @category admin
 *
 * @package masters
 ...
 *
 * @class Post_management_model.php
 *
 * @path application\admin\masters\models\Post_management_model.php
 *
 * @version 4.4
 *
 * @author CIT Dev Team
...
class Post_management_model extends CI_Model
{
    ...
    public function __construct()
    {
        ...
        $this->table_name = "stylist_post";
        $this->table_alias = "sp";
        $this->primary_key = "iStylist_post_id";
    ...
    public function getListConfiguration($name = "")
    {
        $list_config = array(
            "stylist_post_id" => array(
                ...
                "display_query" => "sp.stylist_post_id",
                "entry_type" => "Table",
                "data_type" => "int",
                "show_in" => "Both",
                "type" => "dropdown",
                "align" => "center",
                "label" => "stylist_post Id",
                "lang_code" => "stylist_post Id",
                "label_lang" =>"stylist_post Id",
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "first_name" => array(
                ...
                "align" => "left",
                "label" => "User name",
                "lang_code" => "POST_MANAGEMENT_USER_NAME",
                "label_lang" => $this->lang->line('POST_MANAGEMENT_USER_NAME'),
                "search" => "Yes",
                "width" => 50,
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "title" => array(
                ...
                "field_name" => "title",
                "source_field" => "title",
                "display_query" => "sp.title",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_input" => "Both",
                "type" => "textbox",
                "label" => "Title",
                "lang_code" => "POST_MANAGEMENT_TITLE",
                "label_lang" => $this->lang->line('POST_MANAGEMENT_TITLE'),
                "width" => 50,
            ),
            "post_details" => array(
                "name" => "post_details",
                "table_name" => "stylist_post",
                "table_alias" => "sp",
                "field_name" => "post_details",
                "source_field" => "post_details",
                "display_query" => "sp.post_details",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_input" => "Both",
                "type" => "textbox",
                "label" => "post details",
                "lang_code" => "POST_MANAGEMENT_DETAILS",
                "label_lang" => $this->lang->line('POST_MANAGEMENT_DETAILS'),
                "width" => 50,
            ),
            "created_at" => array(
                "name" => "created_at",
                ...
                "align" => "left",
                "label" => "Created On",
                "lang_code" => "POST_MANAGEMENT_ADDED_AT",
                "label_lang" => $this->lang->line('POST_MANAGEMENT_ADDED_AT'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            /*"sys_custom_field_1" => array(
                ...
                "align" => "center",
                "label" => "Edit",
                "lang_code" => "POST_MANAGEMENT_EDIT",
                "label_lang" => "Edit",
                "width" => 50,
                "search" => "No",
                "export" => "No",
    ...
    public function getFormConfiguration($name = "")
    {
        $form_config = array(
            "stylist_post_id" => array(
                ...
                "lang_code" => "stylist post Id",
                "label_lang" =>"stylist post Id",
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
