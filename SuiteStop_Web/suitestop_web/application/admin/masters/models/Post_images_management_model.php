...
/**
 * Description of Post Images Management Model
 *
 * @category admin
 *
 * @package masters
 ...
 *
 * @class Post_images_management_model.php
 *
 * @path application\admin\masters\models\Post_images_management_model.php
 *
 * @version 4.4
 *
 * @author CIT Dev Team
...
class Post_images_management_model extends CI_Model
{
    public $table_name;
    public $table_alias;
    public $primary_key;
    ...
    public function __construct()
    {
        ...
        $this->table_name = "stylist_images";
        $this->table_alias = "si";
        $this->primary_key = "iStylist_images_id";
        ...
        $this->join_tables = array(
            ...
            array(
                "table_name" => "stylist_post",
                "table_alias" => "sp",
                "field_name" => "iStylist_post_id",
                "rel_table_name" => "stylist_images",
                "rel_table_alias" => "si",
                "rel_field_name" => "iStylist_post_id",
                "join_type" => "left",
                "extra_condition" => ""
            )
        );
    ...
    public function getData($extra_cond = "", $fields = "", $order_by = "", $group_by = "", $limit = "", $join = "No", $having_cond = '', $list = FALSE)
    {
        ...
        elseif ($list == TRUE)
        {
            ...
            $this->db->select("sp.vTitle AS title");
            $this->db->select("si.vImages AS images");
            $this->db->select("si.dtCreated_at AS created_at");
            //$this->db->select("('view') AS sys_custom_field_1", FALSE);
        }
        else
        {
            //$this->db->select("iSpace_id AS space_id");
            $this->db->select("si.iUser_id AS user_id");
            $this->db->select("si.iStylist_post_id AS stylist_post_id");
            $this->db->select("si.vImages AS images");
            $this->db->select("si.dtCreated_at AS created_at");
            //$this->db->select("('view') AS sys_custom_field_1", FALSE);
        }
    ...
    {
        $list_config = array(
            "stylist_images_id" => array(
                "name" => "stylist_images_id",
                "table_name" => "stylist_images",
                "table_alias" => "si",
                "field_name" => "stylist_images_id",
                "source_field" => "stylist_images_id",
                "display_query" => "stylist_images_id",
                "entry_type" => "Table",
                "data_type" => "int",
                "show_in" => "Both",
                "type" => "dropdown",
                "align" => "center",
                "label" => "stylist post images Id",
                "lang_code" => "stylist post images Id",
                "label_lang" =>"stylist post images Id",
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            "first_name" => array(
                ...
                "align" => "left",
                "label" => "User name",
                "lang_code" => "POST_IMAGES_MANAGEMENT_USER_NAME",
                "label_lang" => $this->lang->line('POST_IMAGES_MANAGEMENT_USER_NAME'),
                "search" => "Yes",
                "width" => 50,
                "export" => "Yes",
                "sortable" => "Yes",
                ...
                "edit_link" => "Yes",
                "custom_link" => "Yes",
                "php_func" => "controller::listingValue2"
            ),
            "title" => array(
                "name" => "title",
                "table_name" => "stylist_post",
                "table_alias" => "sp",
                "field_name" => "vTitle",
                "source_field" => "stylist_post_id",
                "display_query" => "sp.vTitle",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_input" => "Both",
                "type" => "textbox",
                "label" => "stylist post title",
                "lang_code" => "POST_IMAGES_MANAGEMENT_TITLE",
                "label_lang" => $this->lang->line('POST_IMAGES_MANAGEMENT_TITLE'),
                "width" => 50,
            ...
            "images" => array(
                ...
                "field_name" => "images",
                "source_field" => "images",
                "display_query" => "images",
                "entry_type" => "Table",
                "data_type" => "varchar",
                "show_input" => "Both",
                "type" => "textbox",
                "label" => "stylist post images",
                "lang_code" => "POST_IMAGES_MANAGEMENT_IMAGES",
                "label_lang" => $this->lang->line('POST_IMAGES_MANAGEMENT_IMAGES'),
                "width" => 50,
            ...
            "created_at" => array(
                ...
                "align" => "left",
                "label" => "Created On",
                "lang_code" => "POST_IMAGES_MANAGEMENT_ADDED_AT",
                "label_lang" => $this->lang->line('POST_IMAGES_MANAGEMENT_ADDED_AT'),
                "width" => 50,
                "search" => "Yes",
                "export" => "Yes",
                "sortable" => "Yes",
            ...
            /*"sys_custom_field_1" => array(
                ...
                "align" => "center",
                "label" => "Edit",
                "lang_code" => "SPACE_MEDIA_MANAGEMENT_EDIT",
                "label_lang" => "Edit",
                "width" => 50,
                "search" => "No",
                "export" => "No",
    ...
    public function getFormConfiguration($name = "")
    {
        $form_config = array(
            ...
            "stylist_post_id" => array(
                "name" => "stylist_post_id",
                "table_name" => "stylist_images",
                "table_alias" => "si",
                "field_name" => "stylist_post_id",
                "source_field" => "stylist_post_id",
                "display_query" => "stylist_post_id",
                "entry_type" => "Table",
                "data_type" => "int",
                "show_in" => "Both",
                "type" => "dropdown",
                "align" => "center",
                "label" => "stylist post Id",
                "lang_code" => "POST_IMAGES_MANAGEMENT_TITLE",
                "label_lang" => $this->lang->line('POST_IMAGES_MANAGEMENT_TITLE'),
                "width" => 50,
                "search" => "Yes",
            ...
            "images" => array(
                ...
                "file_inline" => "Yes",
                "file_server" => "amazon",
                "file_folder" => $this->config->item("AWS_FOLDER_NAME")."/stylist_post_images",
                "file_keep" => "stylist_images_id",
                "file_width" => "80",
                "file_height" => "80"
            ),
            "created_at" => array(
