<?php
/* Smarty version 3.1.28, created on 2021-08-27 14:18:27
  from "/var/www/html/Appineers_V4_Web/Appineers_V4/application/admin/tools/views/mobile_applications_add.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.28',
  'unifunc' => 'content_6128f4331eda42_95106898',
  'file_dependency' => 
  array (
    'c020d81ddda7410fbce4a0d64072d0830f469f86' => 
    array (
      0 => '/var/www/html/Appineers_V4_Web/Appineers_V4/application/admin/tools/views/mobile_applications_add.tpl',
      1 => 1626450606,
      2 => 'file',
    ),
  ),
  'includes' => 
  array (
    'file:mobile_applications_add_strip.tpl' => 1,
    'file:mobile_applications_tabs.tpl' => 1,
    'file:mobile_applications_add_buttons.tpl' => 1,
  ),
),false)) {
function content_6128f4331eda42_95106898 ($_smarty_tpl) {
...
<div class="module-form-container">
    <?php $_smarty_tpl->smarty->ext->_subtemplate->render($_smarty_tpl, "file:mobile_applications_add_strip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>
                ...
                <div id="ad_form_outertab" class="module-navigation-tabs">
                    <?php if ($_smarty_tpl->tpl_vars['tabing_allow']->value == true) {?>
                        <?php if ($_smarty_tpl->tpl_vars['mode']->value == "Update") {?>
                            <?php $_smarty_tpl->smarty->ext->_subtemplate->render($_smarty_tpl, "file:mobile_applications_tabs.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>
...
" />
                        <input type="hidden" name="mam_date_added" id="mam_date_added" value="<?php echo $_smarty_tpl->tpl_vars['this']->value->general->dateSystemFormat($_smarty_tpl->tpl_vars['data']->value['mam_date_added']);?>
...
'  aria-format-type='date' />
                        <input type="hidden" name="mam_added_by" id="mam_added_by" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['mam_added_by'];?>
"  class='ignore-valid ' />
                        <input type="hidden" name="mam_date_updated" id="mam_date_updated" value="<?php echo $_smarty_tpl->tpl_vars['this']->value->general->dateSystemFormat($_smarty_tpl->tpl_vars['data']->value['mam_date_updated']);?>
"  class='ignore-valid '  aria-date-format='<?php echo $_smarty_tpl->tpl_vars['this']->value->general->getAdminJSFormats('date','dateFormat');?>
'  aria-format-type='date' />
                        <input type="hidden" name="mam_updated_by" id="mam_updated_by" value="<?php echo $_smarty_tpl->tpl_vars['data']->value['mam_updated_by'];?>
"  class='ignore-valid ' />
...
"><h4><?php echo $_smarty_tpl->tpl_vars['this']->value->lang->line('MOBILE_APPLICATIONS_MOBILE_APPLICATIONS');?>
</h4></div>
...
">
                                        <div class="form-row row-fluid " id="cc_sh_mam_application_name">
                                            <label class="form-label span3 ">
                                                <?php echo $_smarty_tpl->tpl_vars['form_config']->value['mam_application_name']['label_lang'];?>
 <em>*</em> 
                                            </label> 
                                            <div class="form-right-div  ">
                                                <input type="text" placeholder="" value="<?php echo htmlentities($_smarty_tpl->tpl_vars['data']->value['mam_application_name']);?>
" name="mam_application_name" id="mam_application_name" title="<?php echo $_smarty_tpl->tpl_vars['this']->value->lang->line('MOBILE_APPLICATIONS_APPLICATION_NAME');?>
"  class='frm-size-medium'  />
                                        ...
                                        <div class="form-row row-fluid " id="cc_sh_mam_device_type">
                                            <label class="form-label span3 ">
                                                <?php echo $_smarty_tpl->tpl_vars['form_config']->value['mam_device_type']['label_lang'];?>
 <em>*</em> 
                                            </label> 
                                            <div class="form-right-div  ">
                                                <?php $_smarty_tpl->tpl_vars["opt_selected"] = new Smarty_Variable($_smarty_tpl->tpl_vars['data']->value['mam_device_type'], null);
$_smarty_tpl->ext->_updateScope->updateScope($_smarty_tpl, "opt_selected", 0);?>
                                                <?php echo $_smarty_tpl->tpl_vars['this']->value->dropdown->display("mam_device_type","mam_device_type","  title='".((string)$_smarty_tpl->tpl_vars['this']->value->lang->line('MOBILE_APPLICATIONS_DEVICE_TYPE'))."'  aria-chosen-valid='Yes'  class='chosen-select frm-size-medium'  data-placeholder='".((string)$_smarty_tpl->tpl_vars['this']->value->general->parseLabelMessage('GENERIC_PLEASE_SELECT__C35FIELD_C35','#FIELD#','MOBILE_APPLICATIONS_DEVICE_TYPE'))."'  ","|||",'',$_smarty_tpl->tpl_vars['opt_selected']->value,"mam_device_type");?>
                                        ...
                                        <div class="form-row row-fluid " id="cc_sh_mam_status">
                                            <label class="form-label span3 ">
                                                <?php echo $_smarty_tpl->tpl_vars['form_config']->value['mam_status']['label_lang'];?>
 <em>*</em> 
                                            </label> 
                                            <div class="form-right-div  ">
                                                <?php $_smarty_tpl->tpl_vars["opt_selected"] = new Smarty_Variable($_smarty_tpl->tpl_vars['data']->value['mam_status'], null);
$_smarty_tpl->ext->_updateScope->updateScope($_smarty_tpl, "opt_selected", 0);?>
                                                <?php echo $_smarty_tpl->tpl_vars['this']->value->dropdown->display("mam_status","mam_status","  title='".((string)$_smarty_tpl->tpl_vars['this']->value->lang->line('MOBILE_APPLICATIONS_STATUS'))."'  aria-chosen-valid='Yes'  class='chosen-select frm-size-medium'  data-placeholder='".((string)$_smarty_tpl->tpl_vars['this']->value->general->parseLabelMessage('GENERIC_PLEASE_SELECT__C35FIELD_C35','#FIELD#','MOBILE_APPLICATIONS_STATUS'))."'  ","|||",'',$_smarty_tpl->tpl_vars['opt_selected']->value,"mam_status");?>
...
$_smarty_tpl->ext->_updateScope->updateScope($_smarty_tpl, 'rm_ctrl_directions', 0);?>
                                <?php }?>
                                <?php $_smarty_tpl->smarty->ext->_subtemplate->render($_smarty_tpl, "file:mobile_applications_add_buttons.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>
...
<?php echo $_smarty_tpl->tpl_vars['this']->value->js->add_js('admin/mobile_applications_add_js.js');?>
