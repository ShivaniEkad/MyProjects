...
$config["request_list"] = array(
    "title" => "Space Requested list",
    "folder" => "request",
    "method" => "GET_POST",
    "params" => array(
    ),
...
$config["add_to_myfavorite"] = array(
    "title" => "Add to MyFavorite",
    "folder" => "space",
    "method" => "GET_POST",
    "params" => array(
    ),
...
$config["landlord_profile"] = array(
    "title" => "landlord own profile",
    "folder" => "space",
    "method" => "GET_POST",
    "params" => array(
    ),
...
$config["stylist_profile"] = array(
    "title" => "stylist own profile",
    "folder" => "space",
    "method" => "GET_POST",
    "params" => array(
    ),
...
$config["myfavorite_list"] = array(
    "title" => "Stylist myfavorite list",
    "folder" => "space",
    "method" => "GET_POST",
    "params" => array(
    ),
...
$config["owner_space_list"] = array(
    "title" => "Owner space list",
    "folder" => "space",
    "method" => 'GET',
    "params" => array(
    ),
...
$config["space_exist"] = array(
    "title" => "space exist or not",
    "folder" => "chat",
    "method" => 'GET',
    "params" => array(
    ),
